...
public class WalletsActivity extends BaseActivity implements
        ...
        AddWalletView.OnImportWalletClickListener, WalletsAdapter.OnExportWalletListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new WalletsAdapter(this::onSetWalletDefault, this::onDeleteWallet, this);
        ...
        viewModel.exportedPhrase().observe(this, this::openShareDialog);
        ...
        dialog = buildDialog()
                ...
                .setPositiveButton(android.R.string.yes, (dialog, btn) -> {
                    if (wallet.isMnemonic) {
                        viewModel.deletePhraseWallet(wallet);
                    } else {
    ...
    @Override
    public void onExport(Wallet wallet) {
        showBackupDialog(wallet, false);

    }

    @Override
    public void onExportPhrase(Wallet wallet) {
        viewModel.exportPhraseWallet(wallet);
    }
}
